...
source(here(".//inVitro//JensUpdateLogisticFunction//dataSecondSet.R"))
...
runModel <- function(inits=list("r"=0.08,"k"=15)
                     ,params=c("tau.u","tau.e","r","k", "logTiter_pred")
                     ,ni=10000
                     ,nb=1000
                     ,nt=1
                     ,nc=3
...
tiff(here(".//inVitro//JensUpdateLogisticFunction//fig_2ndSetEstimateR.tiff"), height =5, width = 4, units = 'in', compression="lzw", res=400)
...
tiff(here(".//inVitro//JensUpdateLogisticFunction//fig_2ndSetEstimatek.tiff"), height =5, width = 4, units = 'in', compression="lzw", res=400)
...
tiff(here(".//inVitro//JensUpdateLogisticFunction//fig_2ndSetEstimateS.tiff"), height =5, width = 4, units = 'in', compression="lzw", res=400)
...
tiff(here(".//inVitro//JensUpdateLogisticFunction//fig_2ndSetModelFits.tiff"), height =5, width = 5, units = 'in', compression="lzw", res=400)
ggplot() +
...
tiff(here(".//inVitro//JensUpdateLogisticFunction//fig_2ndSetModelFitsshowingbyNSP.tiff"), height =4, width = 5, units = 'in', compression="lzw", res=400)
ggplot() +
