library(here)
source(here(".//inVitro//JensOriginalFiles//functionInfectionModelWithEclipseWithCellDeath.R"))
source(here(".//inVitro//JensOriginalFiles//functionLikelihood.R"))
source(here(".//inVitro//JensOriginalFiles//data.R"))
library(bbmle)
...
senegalFit <- mle2(function(par1,par2){nllPois(par1,par2,senegal)}                       
